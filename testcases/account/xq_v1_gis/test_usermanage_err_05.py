...
import api_call.account.xq_api.xq_api_for_usermanage_auth_err_05 as ybm_api
...
class UserTest(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        403
        {
  "errorCode": "promethean.auth.invalid.authorization.header"}
Invalid Authorization header in request	Provide a valid value for the Authorization header of the form "Bearer {{jwt}}"
        '''
