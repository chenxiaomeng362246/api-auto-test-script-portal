...
import api_call.account.xq_api.xq_api_for_usermanage_auth_err_06 as ybm_api
...
class UserTest(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        '''
        500	{
  "errorCode": "promethean.user-management.server_error",
  "message": "request size did not match content length"
}	no request body provided	Include a Body as part of the request
        '''
