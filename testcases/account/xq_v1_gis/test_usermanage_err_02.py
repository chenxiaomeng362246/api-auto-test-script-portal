...
import api_call.account.xq_api.xq_api_for_usermanage_auth_err_02 as ybm_api
...
class UserTest(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        '''
        403	{
  "errorCode": "promethean.auth.invalid.jwt"
}
An invalid or expired Authorization header in request

Confirm that the 'Authorization' header has a valid token that is not expired
        '''



    def test_usrmanagement_expired_Authorization_403(self):
        '''
