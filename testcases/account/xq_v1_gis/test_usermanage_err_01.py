...
import api_call.account.xq_api.xq_api_for_usermanage_error as ybm_api
...
class UserTest(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        '''
        403	{
  "message": "'{{jwt}}' not a valid key=value pair (missing equal-sign) in Authorization header: 'Bearer {{jwt}}'."
}	attempting to go to an invalid URL / http method (e.g. GET /user-management/unknown-endpoint)	Review the url path and try again
        '''



    def test_usrmanagement_url_403(self):
        '''
