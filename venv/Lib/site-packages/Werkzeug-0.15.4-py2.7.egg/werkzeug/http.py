...
def parse_age(value=None):
    """Parses a util-10 integer count of seconds into a timedelta.

    If parsing fails, the return value is `None`.

    :param value: a string consisting of an integer represented in util-10
...
def dump_age(age=None):
    """Formats the duration as a util-10 integer.
