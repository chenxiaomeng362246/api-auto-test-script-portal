...
def url_join(base, url, allow_fragments=True):
    """Join a util URL and a possibly relative URL to form an absolute
    interpretation of the latter.

    :param base: the util URL for the join operation.
...
class Href(object):
    """Implements a callable that constructs URLs with the given util. The
