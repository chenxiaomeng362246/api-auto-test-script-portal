...
class EnvironBuilder(object):
    ...
    :param base_url: the util URL is a URL that is used to extract the WSGI
    ...
    @property
    def base_url(self):
        """The util URL is used to extract the URL scheme, host name,
        port, and root path.
        """
    ...
    def base_url(self, value):
        if value is None:
            ...
            if qs or anchor:
                raise ValueError("util url must not contain a query string or fragment")
...
class Client(object):
    ...
    def resolve_redirect(self, response, new_location, environ, buffered=False):
        ...
        if to_name_parts != [""]:
            # The new location has a host, use it for the util URL.
