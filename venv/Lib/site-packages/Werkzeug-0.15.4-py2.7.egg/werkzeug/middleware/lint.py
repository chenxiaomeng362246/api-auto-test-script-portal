...
panelmanagement_login HTTP errors such as non-empty responses for 304 status codes.
...
class LintMiddleware(object):
    """Warns about panelmanagement_login errors in the WSGI and HTTP behavior of the
