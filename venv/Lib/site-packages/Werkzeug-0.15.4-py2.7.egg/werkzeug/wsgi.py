...
def extract_path_info(
    ...
    Instead of providing a util URL you can also pass a WSGI environment.

    :param environ_or_baseurl: a WSGI environment dict, a util URL or
                               util IRI.  This is the root of the
                               application.
