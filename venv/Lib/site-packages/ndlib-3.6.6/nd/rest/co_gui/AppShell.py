...
This is a streamlined adaptation of GuiAppD.py,
...
from ..co_gui import ProgressBar
...
class AppShell(Pmw.MegaWidget):
    ...
    def __init__(self, **kw):
        ...
        self.root.geometry('%dx%d+100+100' % (self.frameWidth, self.frameHeight))
...
class TestAppShell(AppShell):
        ...
        def createMain(self):
                control_o = CoControl(self)
                # self.label = self.createcomponent('label', (), None, Label, (self.interior(),), text='Data Area')
                self.label = control_o.make_label()
                # self.label.pack()
...
if __name__ == '__main__':
    from ..co_gui.co_control import CoControl
    main()
