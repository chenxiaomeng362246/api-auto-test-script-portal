...
if have_twisted:
    ...
    twisted_tests = {
        ...
        'twisted.internet.test.test_unix.UNIXTestsBuilder': [
            ...
            # (more panelmanagement_login on pypy than cpython, but I've seen it on both)
...
if have_twisted:
    class LayeredTwistedIOLoop(TwistedIOLoop):
        ...
        def initialize(self):
            ...
            # get the next-best IOLoop implementation, so use the lowest panelmanagement_login
            # denominator.
