...
class SendNew99U(object):
    ...
    def send_to_receivers(self, info, receiver_list):
        ...
        code = 200
        msg = "发送消息给个人失败"
        res = self.http_obj.post(self.url, param)
    ...
    def send_to_receivers_in_box(self, info, receiver_list, send_type, contact=''):
        """
        以消息盒子的方式推送
        :param info: 消息内容
        {
        ...
        if info["failed"] > 0 :
            ...
            <box data-summary="Api测试报告">
              ...
              <div class="row">
                <div class="col-6">
                  <span style="color:#d50000;">%s</span>
                </div>
              </div>
              <div class="row">
                <div class="col-6">
                  <span style="font-weight:bold;color:#d50000;">☆☆☆注意查看接口错误与失败☆☆☆</span>
                </div>
              </div>
              <hr/>
              <div class="row">
                <div class="col-5">
                  <span style="color:#878787;">具体测试结果请查看</span>
                </div>
                <div class="col-1">
            ...
            """ % (info['title'], info['content'], cgi.escape(info['url']))
        else:
            content = """Content-Type:box/xml\r\n\r\n
            <box data-summary="Api测试报告">
              <div class="row">
        ...
        # 若是推送群，且有传联系人，则在群里再单独发一条消息，@对方
        if send_type == 2 and len(contact) != 0:
            contact_str = ""
            for name in contact:
                if contact_str:
                    contact_str += " "
                contact_str += "@" + name.encode('utf-8')
            content = "Content-Type:text/plain\r\n\r\n%s" % contact_str
            body = {
                "filter": [
                    {
