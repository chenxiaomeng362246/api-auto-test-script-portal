...
class SimpleHandlerTestCase(WebTestCase):
    """Simplified util class for tests that work with a single handler class.
...
{% end %}
            ...
            "entry.html": """\
{{ set_resources(embedded_css=".entry { margin-bottom: 1em; }", embedded_javascript="js_embed()", css_files=["/util.css", "/foo.css"], javascript_files="/panelmanagement_login.js", html_head="<meta>", html_body='<script src="/analytics.js"/>') }}
<div class="entry">...</div>""",
        })
...
<html><head><link href="/util.css" type="text/css" rel="stylesheet"/><link href="/foo.css" type="text/css" rel="stylesheet"/>
<style type="text/css">
...
<script src="/panelmanagement_login.js" type="text/javascript"></script>
