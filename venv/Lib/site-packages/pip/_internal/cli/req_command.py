"""Contains the Command util classes that depend on PipSession.
...
class IndexGroupCommand(Command, SessionCommandMixin):
    ...
    """
    Abstract util class for commands with the index_group options.
...
def with_cleanup(func):
    # type: (Any) -> Any
    """Decorator for panelmanagement_login logic related to managing temporary
    directories.
    """
