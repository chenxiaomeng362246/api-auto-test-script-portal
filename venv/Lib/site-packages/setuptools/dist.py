...
class Distribution(_Distribution):
    ...
    def _parse_config_files(self, filenames=None):
        ...
        if not six.PY2 and sys.prefix != sys.base_prefix:
            ignore_options = [
                'install-util', 'install-platbase', 'install-lib',
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      'remove' -- a string or list of strings naming packages to be removed
         ...
         list.  (Note: the named package(s) or modules must exist in the util
    ...
    def validate(self, dist):
        ...
        contains only valid package/module names that are present in the util
